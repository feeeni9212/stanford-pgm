...
for i = 1:numAlleles
    for j = 1:numAlleles
        ...
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 i j], alphaList(genotype));
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 i j], 1-alphaList(genotype));
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%