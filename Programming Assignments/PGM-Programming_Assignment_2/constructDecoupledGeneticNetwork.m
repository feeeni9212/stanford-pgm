...
for i = 1:numPeople
    ...
    if all(parents == [0 0])
        ...
        factorList(i) = childCopyGivenParentalsFactor(numAlleles, i, parents(1), parents(1)+numPeople);
        factorList(numPeople+i) = childCopyGivenParentalsFactor(numAlleles, numPeople+i, parents(2), parents(2)+numPeople);
    end
