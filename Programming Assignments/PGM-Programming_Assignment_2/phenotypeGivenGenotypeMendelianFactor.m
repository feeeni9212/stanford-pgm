...
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 1; 1 2; 2 3], isDominant);
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 1; 2 2; 1 3], ~isDominant);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
