...
numGenotypes = length(alphaList);
phenotypeFactor.var = [phenotypeVar genotypeVar];
phenotypeFactor.card = [2 numGenotypes];

phenotypeFactor.val = zeros(1, prod(phenotypeFactor.card));
% Replace the zeros in phentoypeFactor.val with the correct values.
traitIndx = ones(numGenotypes,1);
genotypeIndx = [1:numGenotypes]';
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [traitIndx genotypeIndx], alphaList);
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2*traitIndx genotypeIndx], 1-alphaList);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
