...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
F = F(unique([G.var2factors{find(A_prop-A)}]));     % relevant factors
logP = log_QY_ratio + LogR(old_value) - LogR(new_value) + ...
    LogProbOfJointAssignment(F, A_prop) - LogProbOfJointAssignment(F, A);
p_acceptance = min([1 exp(logP)]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
